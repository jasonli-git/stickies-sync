...
Milestone 3 shipped as v0.4.0 on 2026-08-17. One Mac can now read, write, and
track its own notes — what changed, what it used to be, and what was deleted.
Nothing crosses between Macs yet; Milestone 4 is the first that does. A
